...
function showInfo(){
    ...
    getData.forEach((element, index) => {
        let createElement = `<tr class="customerDetails">
            ...
            <td>
                <button class="btn btn-success" onclick="readInfo('${element.picture}', '${element.customerName}', '${element.customerAddr}', '${element.customerPhone}', '${element.customerGender}', '${element.customerAi}')" data-bs-toggle="modal" data-bs-target="#readData"><i class="bi bi-eye"></i></button>

                <button class="btn btn-primary" onclick="editInfo(${index}, '${element.picture}', '${element.customerName}', '${element.customerAddr}', '${element.customerPhone}', '${element.customerGender}', '${element.customerAi}')" data-bs-toggle="modal" data-bs-target="#userForm"><i class="bi bi-pencil-square"></i></button>
...
function readInfo(pic, name, addr, phone, gender, ai){
...
function editInfo(index, pic, name, Addr, Phone, Gender, Ai){
    isEdit = true
    editId = index
    imgInput.src = pic
    userName.value = name
